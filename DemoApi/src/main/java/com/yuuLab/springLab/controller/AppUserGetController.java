...
@RestController
public class AppUserGetController {
	
	protected final AppUserInquiryLogic appUserInquiryLogic;
	
	
	@Autowired
	public AppUserGetController(AppUserInquiryLogic appUserInquiryLogic) {
